...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	// use if written by you or your team mates
    	if (writtenByYourself)
    		return true;
    	
    	// if implementation by you is required, you cannot use this code since you did not write it
    	if (implementationRequired)
    		return false;
    	
    	// if you did not write and there is no restriction for being written by you, then
    	// if code is available to others, not part of course work and you cite it, then good
    	if (availableToOthers && citingYourSource && !writtenAsCourseWork)
    		return true;
